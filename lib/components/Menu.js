...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.render = function () {
        ...
        return (react_1.default.createElement(Portal_1.Portal, null, visible && (react_1.default.createElement("div", { className: cssClasses, style: menuStyle, ref: this.setRef, onMouseEnter: this.onMouseEnter, onMouseLeave: this.onMouseLeave, role: "menu" },
